...
(function () {
    ...
    var $about = $('.about');
    var $case_wrapper = $('.case-wrapper');
    var $design = $('.design');
    var $404_wrapper = $('.wrapper-404');
    var $header = $('.main-header');
    var $menu = $('.menu-toggle');
    var $home_content = $('.home-content-wrapper');
    var $spacing = $('.spacing');
...
(function () {
    ...
    var $body = $('body');
    var $cursor = $('.cursor');
    var $cursorbck = $('.cursor-background');
    ...
    function initCursor() {
        $body.on('mousemove', function () {}).on('mouseenter', "a, button, .typed-about, #name-input, #lastname-input, #email-input, #message-input, .click-text", function () {
...
(function () {
    ...
    var $menu_open_btn = $('.menu-toggle:before');
    var $menu_close_btn = $('.menu-toggle:after');
    var $main_menu = $('.menu-wrapper');
